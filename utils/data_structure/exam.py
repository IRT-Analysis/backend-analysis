class Exam:
    def __init__(self, code, question_bank, question_order=None, answer_order=None):
        ...
        self.question_order = question_order or list(question_bank.get_all_questions().keys())  # Thứ tự câu hỏi trong mã đề
        self.answer_order = answer_order or {}  # Thứ tự đáp án cho từng câu hỏi trong mã đề (được khởi tạo)
